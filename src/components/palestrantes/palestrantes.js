...
export default function Palestrantes() {
  ...
  return (
    <Card title={"Palestrantes"}>
      <p>
        Conheça os renomados especialistas que irão compartilhar conhecimento e
        experiências sobre defesa agropecuária, inovação tecnológica e
        sustentabilidade na agricultura amazônica. Nossos palestrantes são
        referências em suas áreas de atuação, trazendo insights valiosos para o
      ...
      <p>
        ...
        <strong>universitários</strong>. Cada palestra contará com a emissão de{" "}
        <strong>certificado de participação</strong>, que poderá ser utilizado
        por universitários como <strong>horas complementares</strong> em sua
        formação acadêmica.
      </p>
                ...
                {sessao.palestrantes.map((palestrante, palestranteIndex) => (
                  <div key={palestranteIndex} className="palestrante-card">
                    ...
                    <div className="palestrante-info">
                      ...
                      <p className="palestrante-formacao">
                        {palestrante.formacao}
                      </p>
                      ...
                      <p className="palestrante-sala">
                        <span className="sala-badge-palestrantes">
                          {palestrante.sala}
                        </span>
                      </p>
                    </div>
